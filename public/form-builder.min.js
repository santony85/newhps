    ...
    !(function (e) {
        ...
        function (t, r, o) {
            ...
            const s = function (e, t = !1) {
                ...
                u = (e) =>
                    Object.entries(e)
                        .map(([e, t]) => d(e) && Object.values(f(e, t)).join(""))
                        .filter(Boolean)
                        .join(" "),
                f = (e, t) => {
                    let r;
                    return (e = m(e)), t && (Array.isArray(t) ? (r = q(t.join(" "))) : ("boolean" == typeof t && (t = t.toString()), (r = q(t.trim())))), { name: e, value: (t = t ? `="${r}"` : "") };
                },
                ...
                x = (e) => {
                    ...
                    for (let r = 0; r < e.length; r++) {
                        const o = i(i({}, v(e[r])), {}, { label: e[r].textContent });
                        t.push(o);
                    }
                    return t;
                },
                    ...
                    const t = (e = Array.isArray(e) ? e : [e]).map(
                        ({ src: e, id: t }) =>
                            new Promise((r) => {
                                ...
                                const o = w("link", null, { href: e, rel: "stylesheet", id: t });
        ...
        function (e, t, r) {
            ...
            const i = {
                ...
                l = { btn: ["default", "danger", "info", "primary", "success", "warning"] },
        ...
        function (e, t, r) {
            ...
            const o = {},
                n = { text: ["text", "password", "email", "color", "tel"], header: ["h1", "h2", "h3"], button: ["button", "submit", "reset"], paragraph: ["p", "address", "blockquote", "canvas", "output"], textarea: ["textarea", "quill"] },
                i = (e) => {
        ...
        function (e, t, r) {
            ...
            class l extends o.a {
                static register(e = {}, t = []) {
                    (l.customRegister = {}), l.def || (l.def = { icon: {}, i18n: {} }), (l.templates = e);
                    const r = i.a.locale;
                    ...
                    for (const n of t) {
                        ...
                        if (!e[t]) {
                            ...
                            (i = n.datatype ? n.datatype : `${t}-${Math.floor(9e3 * Math.random() + 1e3)}`), (l.customRegister[i] = jQuery.extend(n, { type: t, class: e }));
                        }
        ...
        function (e, t, r) {
            ...
            function s(e, t) {
                for (var r = {}, o = [], n = 0; n < e.length; n++) {
                    ...
                    -1 !== u ? (l[u].references++, l[u].updater(f)) : l.push({ identifier: c, updater: h(f, t), references: 1 }), o.push(c);
                }
                return o;
            }
            function d(e) {
                ...
                constructor(e, t) {
                    (this.preview = t),
                        (this.templates = {
                            label: null,
                            help: null,
                            default: (e, t, r, o) => (r && t.appendChild(r), this.markup("div", [t, e], { className: n(o, e) })),
                            noLabel: (e, t, r, o) => this.markup("div", e, { className: n(o, e) }),
                            hidden: (e) => e,
                        }),
        ...
        function (t, r, o) {
            ...
            class a extends n.a {
                ...
                build() {
                    const e = this.config,
                        ...
                        s = Object.assign({}, o, { id: o.id + "-input", autocomplete: "off", events: a }),
                        d = Object.assign({}, o, { type: "hidden" });
                    delete s.name;
                    ...
                    return c.push(this.markup("ul", u, { id: o.id + "-list", className: `formbuilder-${r}-list` })), c;
                }
                hideList(e) {
            ...
            class p extends n.a {
                build() {
                    ...
                    return n[t] && (o = n[t]), { field: this.markup(o, u.f.parsedHtml(this.label), r), layout: "noLabel" };
                }
            }
            function m(e, t) {
                if (null == e) return {};
            ...
            class b extends n.a {
                ...
                build() {
                    const e = [],
                        ...
                        c = i.replace("-group", ""),
                        f = "select" === i;
                    if (((d.multiple || "checkbox-group" === i) && (d.name = d.name + "[]"), "checkbox-group" === i && d.required && (this.onRender = this.groupRequired), delete d.title, r)) {
                        n && f && e.push(this.markup("option", n, { disabled: null, selected: null }));
                        ...
                        if (!f && a) {
                            const t = { id: d.id + "-other", className: d.className + " other-option", value: "" };
                            let r = "formbuilder-" + c;
                            l && (r += "-inline");
                            ...
                            const n = {
                                ...
                                u = this.markup("div", [i, s], { className: r });
                            e.push(u);
                        }
                    }
                    return (this.dom = "select" == i ? this.markup(c, e, Object(u.A)(d, !0)) : this.markup("div", e, { className: i })), this.dom;
                }
                groupRequired() {
                            ...
                            !0,
                            {
                                ...
                                callbacks: {
                                    ...
                                    onStatusChange: (e, o, n) => {
                                        ...
                                        return r.val(l.join(", ")), { id: e, oldStatus: o, newStatus: n };
                                    },
                                },
            ...
            class q extends w {
                configure() {
                    ...
                    Object.assign(this, j(j({}, { js: "//cdn.quilljs.com/1.2.4/quill.js", css: "//cdn.quilljs.com/1.2.4/quill.snow.css" }), t)), (this.editorConfig = j(j({}, e), r));
                }
                build() {
                    const e = this.config,
                        { value: t = "" } = e,
        ...
        function (t, r, o) {
            ...
            class y {
                ...
                prepData(t) {
                    ...
                    return (
                        0 !== t.childNodes.length &&
                            Object(p.i)(t.childNodes, function (t, i) {
                                const l = e(i);
                ...
                getData(e) {
                    ...
                    const r = { xml: (e) => (Array.isArray(e) ? e : Object(p.t)(e)), json: (e) => ("string" == typeof e ? window.JSON.parse(e) : e) };
                ...
                save(e) {
                    const t = this,
                        r = this.data,
                        o = this.d.stage,
                        n = { xml: (e) => t.xmlSave(o, e), json: (e) => window.JSON.stringify(t.prepData(o), null, e && "  ") };
                ...
                updatePreview(t) {
                    ...
                    const i = t.attr("type"),
                        a = e(".prev-holder", n);
                    let s = Object.assign({}, this.getAttrVals(n), { type: i });
                ...
                disabledTT(e) {
                    ...
                    Object(p.i)(t, (e) => {
                        ...
                        if (o) {
                            const e = Object(p.q)("p", o, { className: "frmb-tt" });
                            r.appendChild(e),
                ...
                editorLayout(e) {
                    return { left: { stage: "pull-right", controls: "pull-left" }, right: { stage: "pull-left", controls: "pull-right" } }[e] || "";
                }
                showOverlay() {
                    const e = Object(p.q)("div", null, { className: "form-builder-overlay" });
                ...
                confirm(e, t, r = !1, o = "") {
                    const n = this,
                        i = c.a.current,
                        l = n.showOverlay(),
                        a = Object(p.q)("button", i.yes, { className: "yes btn btn-success btn-sm" }),
                        s = Object(p.q)("button", i.no, { className: "no btn btn-danger btn-sm" });
                    (s.onclick = function () {
                        n.closeConfirm(l);
                    }),
                        (a.onclick = function () {
                    ...
                    const d = Object(p.q)("div", [s, a], { className: "button-wrap" });
                    o = "form-builder-dialog " + o;
                    const u = Object(p.q)("div", [e, d], { className: o });
                    if (r) u.classList.add("positioned");
                    else {
                        const e = document.documentElement;
                        (r = { pageX: Math.max(e.clientWidth, window.innerWidth || 0) / 2, pageY: Math.max(e.clientHeight, window.innerHeight || 0) / 2 }), (u.style.position = "fixed");
                    }
                ...
                dialog(e, t = !1, r = "") {
                    ...
                    const i = Object(p.q)("div", e, { className: r });
                    return (
                ...
                confirmRemoveAll(t) {
                    const r = this,
                        ...
                        d = { pageX: a.left + a.width / 2, pageY: a.top - s.top - 12 };
                    l.length
                        ? r.confirm(
                              i.clearAllMessage,
                              () => {
                ...
                toggleEdit(t, r = !0) {
                    ...
                    return (
                        ...
                        r ? (i.slideToggle(250), n.slideToggle(250)) : (i.toggle(), n.toggle()),
                        this.updatePreview(e(o)),
                        o.classList.contains("editing")
                            ? ((this.formBuilder.currentEditPanel = n[0]), m.a.opts.onOpenFieldEdit(n[0]), document.dispatchEvent(u.a.fieldEditOpened))
                            : (m.a.opts.onCloseFieldEdit(n[0]), document.dispatchEvent(u.a.fieldEditClosed)),
                        o
                    );
                }
                getStyle(e, t = !1) {
                ...
                stickyControls() {
                    ...
                    e(window).scroll(function (l) {
                        const a = e(l.target).scrollTop(),
                            s = { top: 5, bottom: "auto", right: "auto", left: n.left },
                            d = Object.assign({}, s, m.a.opts.stickyControls.offset);
                        if (a > i) {
                            const e = { position: "sticky" },
                                n = Object.assign(e, d),
                                ...
                                c = l.top + l.height,
                                u = s === c && i.top > a;
                            s > c && i.top !== l.top && o.css({ position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto" }), (s < c || u) && o.css(n);
                ...
                showData() {
                    ...
                    const t = Object(p.q)("code", e, { className: "formData-" + m.a.opts.dataType });
                ...
                removeField(t, r = 250) {
                    ...
                    return d && d.onremove && d.onremove(a), document.dispatchEvent(u.a.fieldRemoved), o;
                }
                processActionButtons(e) {
                    ...
                    let n = t;
                    const i = this.data;
                    (n = n ? c.a.current[n] || n : o.id ? c.a.current[o.id] || Object(p.d)(o.id) : ""), o.id ? (o.id = `${i.formID}-${o.id}-action`) : (o.id = `${i.formID}-action-${Math.round(1e3 * Math.random())}`);
                ...
                editorUI(e) {
                    const t = this.d,
                        r = this.data,
                        o = e || r.formID;
                    (t.editorWrap = Object(p.q)("div", null, { id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.r)() })),
                        (t.stage = Object(p.q)("ul", null, { id: o, className: "frmb stage-wrap " + r.layout.stage })),
                        (t.controls = Object(p.q)("ul", null, { id: o + "-control-box", className: "frmb-control" }));
                    const n = this.formActionButtons();
                    t.formActions = Object(p.q)("div", n, { className: "form-actions btn-group" });
                }
                formActionButtons() {
                    const e = m.a.opts;
                ...
                processOptions(e) {
                    ...
                    return (
                        ...
                        (m.a.opts = Object.assign({}, { actionButtons: l }, { fieldEditContainer: i }, n)),
                        m.a.opts
                    );
                }
                input(e = {}) {
                ...
                getFormData(e = "js", t = !1) {
                    const r = this;
                    return { js: () => r.prepData(r.d.stage), xml: () => r.xmlSave(r.d.stage), json: (e) => window.JSON.stringify(r.prepData(r.d.stage), null, e && "  ") }[e](t);
                }
            }
            o(12);
            var w = o(8);
            class v {
                ...
                setupControls() {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        ...
                        const s = Object(p.q)("li", Object(p.q)("span", l), { className: `${a} input-control input-control-${e}` });
                    ...
                    e.inputSets.length &&
                        e.inputSets.forEach((e, t) => {
                            ...
                            const n = Object(p.q)("li", o, { className: "input-set-control input-set-" + t });
                ...
                orderFields(e) {
                    ...
                    let o;
                    return (
                        window.sessionStorage && (t.sortableControls ? (o = window.sessionStorage.getItem("fieldOrder")) : window.sessionStorage.removeItem("fieldOrder")),
                        o ? ((o = window.JSON.parse(o)), (o = Object(p.B)(o.concat(e))), (o = Object.keys(o).map((e) => o[e]))) : (o = Object(p.B)(r)),
                        o.forEach((e) => {
            ...
            const k = function (e, t, r) {
                    ...
                    const h = new e.layout(e.layoutTemplates, !0),
                        g = new y(a, h, o),
                        O = p.q;
                    (e = g.processOptions(e)), (d.layout = g.editorLayout(e.controlPosition)), g.editorUI(a), (d.formID = a), (d.lastID = d.formID + "-fld-0");
                    const j = new v(e, b),
                    ...
                    const E = (t) => {
                        ...
                        N = r(b.editorWrap),
                        S = O("div", b.controls, { id: d.formID + "-cb-wrap", className: "cb-wrap " + d.layout.controls });
                    ...
                    const L = (t, o = !1) => {
                        ...
                        if (t instanceof jQuery)
                            if (((n.type = t[0].dataset.type), n.type)) {
                                ...
                                o || (n.values = t.children().map((e, t) => ({ label: r(t).text(), value: r(t).attr("value"), selected: Boolean(r(t).attr("selected")) })));
                        ...
                        e.onAddField(d.lastID, n), W(n, o), e.onAddFieldAfter(d.lastID, n), b.stage.classList.remove("empty");
                    };
                    o.prepFieldVars = L;
                    const D = function (t) {
                            (t = g.getData(t)) && t.length
                                ? (t.forEach((e) => L(Object(p.A)(e))), b.stage.classList.remove("empty"))
                                : e.defaultFields && e.defaultFields.length
                                ? g.addDefaultFields()
                                : e.prepend || e.append || (b.stage.classList.add("empty"), (b.stage.dataset.content = c.a.get("getStarted"))),
                                (() => {
                                    const t = [],
                                        o = (t) => O("li", e[t], { className: "disabled-field form-" + t });
                                    return (
                                        e.prepend && !r(".disabled-field.form-prepend", b.stage).length && (t.push(!0), q.prepend(o("prepend"))),
                                        e.append && !r(".disabled-field.form-.append", b.stage).length && (t.push(!0), q.append(o("append"))),
                        ...
                        T = (t) => {
                            const { type: r } = t,
                                ...
                                l = {
                                    required: () => V(t),
                                    toggle: () => M("toggle", t, { first: c.a.get("toggle") }),
                                    inline: () => {
                                        const e = { first: c.a.get("inline"), second: c.a.get("inlineDesc", r.replace("-group", "")) };
                                        return M("inline", t, e);
                                    },
                                    label: () => Q("label", t),
                                    ...
                                    access: () => {
                                        ...
                                        r.push("</div>");
                                        const o = { first: c.a.get("roles"), second: c.a.get("limitRole"), content: r.join("") };
                                        return M("access", t, o);
                                    },
                                    other: () => M("other", t, { first: c.a.get("enableOther"), second: c.a.get("enableOtherMsg") }),
                                    options: () =>
                                        (function (e) {
                                            const { type: t, values: r } = e;
                                            let o;
                                            const n = [O("a", c.a.get("addOption"), { className: "add add-opt" })],
                                                i = [O("label", c.a.get("selectOptions"), { className: "false-label" })],
                                                l = e.multiple || "checkbox-group" === t,
                                                a = (e) => {
                                                    const t = c.a.get("optionCount", e);
                                                    return { selected: !1, label: t, value: Object(p.n)(t) };
                                                };
                                            ...
                                            const s = O("div", n, { className: "option-actions" }),
                                                d = O(
                                                    "ol",
                                                    o.map((e, r) => {
                                                        const o = m.a.opts.onAddOption(e, { type: t, index: r, isMultiple: l });
                                                        return Y(o, l);
                                                    }),
                                                    { className: "sortable-options" }
                                                ),
                                                u = O("div", [d, s], { className: "sortable-options-wrap" });
                                            return i.push(u), O("div", i, { className: "form-group field-options" }).outerHTML;
                                        })(t),
                                    requireValidOption: () => M("requireValidOption", t, { first: " ", second: c.a.get("requireValidOption") }),
                                    multiple: () => {
                                        const e = {
                                            default: { first: "Multiple", second: "set multiple attribute" },
                                            file: { first: c.a.get("multipleFiles"), second: c.a.get("allowMultipleFiles") },
                                            select: { first: " ", second: c.a.get("selectionsMessage") },
                                        };
                        ...
                        const r = [],
                            o = {
                                ...
                                boolean: (e, r) => {
                                    ...
                                    return (
                                        "checkbox" === e.type
                                            ? (o = Boolean(!!r.hasOwnProperty("value") && r.value))
                                            : t.hasOwnProperty(e)
                                            ? (o = t[e])
                                            : (r.hasOwnProperty("value") || r.hasOwnProperty("checked")) && (o = r.value || r.checked || !1),
                                        M(e, A(A({}, r), {}, { [e]: o }), { first: r.label })
                                    );
                                },
                            };
                        for (const i in e)
                    ...
                    function I(e, t) {
                        ...
                        let l = { id: e + "-" + d.lastID, title: i.description || i.label || e.toUpperCase(), name: e, type: i.type || "text", className: ["fld-" + e, (r || o || "").trim()], value: i.value || "" };
                    ...
                    function P(e, t) {
                        const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t,
                            ...
                            p = { id: `${e}-${d.lastID}`, title: u.description || i || e.toUpperCase(), name: e, className: `fld-${e} form-control ${a || s || ""}`.trim() };
                        r && (p.multiple = !0);
                    ...
                    const M = (e, t, r = {}) => {
                            const o = (t) => O("label", t, { for: `${e}-${d.lastID}` }).outerHTML,
                                n = { type: "checkbox", className: "fld-" + e, name: e, id: `${e}-${d.lastID}` };
                            t[e] && (n.checked = !0);
                            const i = [];
                            ...
                            return (
                                ...
                                (l = O("div", l, { className: "input-wrap" }).outerHTML),
                                O("div", i.concat(l), { className: `form-group ${e}-wrap` }).outerHTML
                            );
                        },
                        z = (e) => {
                            let t = "";
                            ...
                            return (
                                (t += g.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML),
                                (t += '<div class="btn-group" role="group">'),
                                m.d.btn.forEach((r) => {
                                    const o = ["btn-xs", "btn", "btn-" + r];
                                    e === r && o.push("selected");
                                    const n = O("button", c.a.get("styles.btn." + r), { value: r, type: "button", className: o.join(" ") }).outerHTML;
                                    t += n;
                                }),
                                (t += "</div>"),
                                (t = O("div", [r, t], { className: "form-group style-wrap" })),
                                t.outerHTML
                            );
                        },
                        U = (e, t) => {
                            const { class: r, className: o, value: n } = t,
                                ...
                                l = c.a.get(e) || e,
                                a = { type: "number", value: i, name: e, placeholder: c.a.get("placeholder." + e), className: `fld-${e} form-control ${r || o || ""}`.trim(), id: `${e}-${d.lastID}` },
                                s = g.input(Object(p.A)(a)).outerHTML;
                            return O("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${s}</div>`], { className: `form-group ${e}-wrap` }).outerHTML;
                        },
                        H = (e, t, r) => {
                            const o = r.map((r, o) => {
                                    let i = Object.assign({ label: `${n.option} ${o}`, value: void 0 }, r);
                                    return r.value === t[e] && (i.selected = !0), (i = Object(p.A)(i)), O("option", i.label, i);
                                }),
                                i = { id: e + "-" + d.lastID, name: e, className: `fld-${e} form-control` },
                                l = c.a.get(e) || Object(p.d)(e) || "",
                                a = O("label", l, { for: i.id }),
                                s = O("select", o, i),
                                u = O("div", s, { className: "input-wrap" });
                            return O("div", [a, u], { className: `form-group ${i.name}-wrap` }).outerHTML;
                        },
                        Q = (t, r, o = !1) => {
                            const n = ["paragraph"];
                            let i = r[t] || "",
                            ...
                            let s = "";
                            if (![].some((e) => !0 === e)) {
                                const n = { name: t, placeholder: a, className: `fld-${t} form-control`, id: `${t}-${d.lastID}` },
                                    c = O("label", l, { for: n.id }).outerHTML;
                                ...
                                let f = o ? "none" : "block";
                                "value" === t && (f = r.subtype && "quill" === r.subtype && "none"), (s = O("div", [c, u], { className: `form-group ${t}-wrap`, style: "display: " + f }));
                            }
                            return s.outerHTML;
                        },
                        V = (e) => {
                            const { type: t } = e,
                                r = [];
                            let o = "";
                            return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some((e) => !0 === e) || (o = M("required", e, { first: c.a.get("required") })), o;
                        },
                        W = function (t, i = !0) {
                            ...
                            let u = [
                                O("a", null, { type: "remove", id: "del_" + d.lastID, className: `del-button btn ${w.a}cancel delete-confirm`, title: c.a.get("removeMessage") }),
                                O("a", null, { type: "edit", id: d.lastID + "-edit", className: `toggle-form btn ${w.a}pencil`, title: c.a.get("hide") }),
                                O("a", null, { type: "copy", id: d.lastID + "-copy", className: `copy-button btn ${w.a}copy`, title: c.a.get("copyButtonTooltip") }),
                            ];
                            s && Array.isArray(s) && (u = u.filter((e) => !s.includes(e.type)));
                            const f = [O("div", u, { className: "field-actions" })];
                            f.push(O("label", Object(p.u)(a), { className: "field-label" })), f.push(O("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                            const m = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                            f.push(O("span", "?", m)), f.push(O("div", "", { className: "prev-holder" }));
                            const h = O("div", [T(t), O("a", c.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                                y = O("div", h, { id: d.lastID + "-holder", className: "frm-holder", dataFieldId: d.lastID });
                            (o.currentEditPanel = y), f.push(y);
                            const v = O("li", f, { class: l + "-field form-field", type: l, id: d.lastID }),
                                x = r(v);
                            x.data("fieldData", { attrs: t }),
                                void 0 !== g.stopIndex ? r("> li", b.stage).eq(g.stopIndex).before(x) : q.append(x),
                                r(".sortable-options", x).sortable({ update: () => g.updatePreview(x) }),
                                g.updatePreview(x),
                                e.typeUserEvents[l] && e.typeUserEvents[l].onadd && e.typeUserEvents[l].onadd(v),
                                i && (e.editOnAdd && (g.closeAllEdit(), g.toggleEdit(d.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({ behavior: "smooth" }));
                        },
                        Y = function (e, t) {
                            const r = { selected: t ? "checkbox" : "radio" },
                                o = {
                                    boolean: (e, t) => {
                                        const o = { value: e, type: r[t] || "checkbox" };
                                        return e && (o.checked = !!e), ["input", null, o];
                                    },
                                    number: (e) => ["input", null, { value: e, type: "number" }],
                                    string: (e, t) => ["input", null, { value: e, type: "text", placeholder: c.a.get("placeholder." + t) || "" }],
                                    array: (e) => ["select", e.map(({ label: e, value: t }) => O("option", e, { value: t }))],
                                    object: (e) => {
                                        let { tag: t, content: r } = e;
                                        return [t, r, x(e, ["tag", "content"])];
                                    },
                                };
                            e = A(A({}, { selected: !1, label: "", value: "" }), e);
                            const n = Object.entries(e).map(([e, t]) => {
                                ...
                                i = { className: `remove btn ${w.a}cancel`, title: c.a.get("removeMessage") };
                    ...
                    q.on(
                        ...
                        q.on("click touchstart", ".remove", (t) => {
                            ...
                            n.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox")
                                ? e.notify.error("Error: " + c.a.get("minOptionMessage"))
                                : l.slideUp("250", () => {
                    ...
                    if (
                        (q.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (e) => {
                            let t;
                        ...
                        q.on("click touchstart", ".delete-confirm", (t) => {
                            ...
                            const o = t.target.getBoundingClientRect(),
                                ...
                                i = { pageX: o.left + o.width / 2, pageY: o.top - n.top - 12 },
                    ...
                    return (
                        ...
                        (o.actions = {
                            ...
                            addField: (e, t) => {
                                (g.stopIndex = d.formData.length ? t : void 0), L(e);
                            },
                            ...
                            setLang: (e) => {
                                c.a.setCurrent.call(c.a, e).then(() => {
                                    (b.stage.dataset.content = c.a.get("getStarted")), j.init(), b.empty(b.formActions), g.formActionButtons().forEach((e) => b.formActions.appendChild(e));
                                });
                            },
                                    ...
                                    c.a
                                        ...
                                        .then(() => {
                                            t.each((e) => {
                                                ...
                                                jQuery(t[e]).data("formBuilder", r), Object.assign(q, r.actions, { markup: p.q }), (q.instance.actions = r.actions);
                                            }),
