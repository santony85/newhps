...
!(function () {
    ...
    window.dhtmlx ||
        ...
        (dhtmlx.extend_api = function (t, e, i) {
            ...
            a &&
                ...
                (window[t].prototype = a.prototype),
        ...
        (dhtmlDragAndDropObject.prototype.calculateFramePosition = function (t) {
            if (window.name) {
                for (var e = parent.frames[window.name].frameElement.offsetParent, i = 0, a = 0; e; ) (i += e.offsetLeft), (a += e.offsetTop), (e = e.offsetParent);
        ...
        (dhtmlDragAndDropObject.prototype.checkLanding = function (t, e) {
            t && t.dragLanding
                ...
                : (this.lastLanding && this.lastLanding.dragLanding._dragOut(this.lastLanding, e.clientX, e.clientY, e), (this.lastLanding = 0), this._onNotFound && this._onNotFound());
        }),
        (dhtmlDragAndDropObject.prototype.stopDrag = function (t, e) {
            ...
            if (!e) {
                i.stopFrameRoute();
                var a = i.lastLanding;
                (i.lastLanding = null), a && a.dragLanding._drag(i.dragStartNode, i.dragStartObject, a, _isIE ? event.srcElement : t.target);
            }
            (i.lastLanding = null),
    ...
    -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0),
        ...
        (dtmlXMLLoaderObject.prototype.doXPath = function (t, e, i, a) {
            ...
            if (_isIE)
                return (
                    ...
                    "single" == a ? e.selectSingleNode(t) : e.selectNodes(t) || new Array(0)
                );
            var n = e;
            e || (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
                e || dhtmlxError.throwError("LoadXML", "Incorrect XML", [e || this.xmlDoc, this.mainObject]),
                -1 != e.nodeName.indexOf("document") ? (n = e) : ((n = e), (e = e.ownerDocument));
        ...
        (dtmlXMLLoaderObject.prototype._getAllNamedChilds = function (t, e) {
            ...
            for (var a = 0; a < t.length; a++)
                for (var n = 0; n < t[a].childNodes.length; n++)
                    _isKHTML ? t[a].childNodes[n].tagName && t[a].childNodes[n].tagName.toUpperCase() == e && (i[i.length] = t[a].childNodes[n]) : t[a].childNodes[n].tagName == e && (i[i.length] = t[a].childNodes[n]);
            return i;
        }),
        ...
        (function () {
            ...
            function r(e, i, n) {
                ...
                if (
                    ...
                    e.title && ((o += '<div class="dhtmlx_popup_title" id="' + s + '">' + e.title + "</div>"), (d = !0)),
                ...
                if (e.buttons) for (var h = 0; h < e.buttons.length; h++) o += a(e.buttons[h], h);
            ...
            function _(t, e, i) {
                return "object" != typeof t && ("function" == typeof e && ((i = e), (e = "")), (t = { text: t, type: e, callback: i })), t;
            }
            function h(t, e, i, a) {
                return "object" != typeof t && (t = { text: t, type: e, expire: i, id: a }), (t.id = t.id || u.uid()), (t.expire = t.expire || u.expire), t;
            }
            var c = null;
    ...
    (dataProcessor.prototype = {
        setTransactionMode: function (t, e) {
            function i(t, e) {
                var i = e.toLowerCase();
                for (var a in t) if (a.toLowerCase() === i) return !0;
                return !1;
            }
            "object" == typeof t ? ((this._tMode = t.mode || this._tMode), void 0 !== t.headers && (this._headers = t.headers), void 0 !== t.payload && (this._payload = t.payload)) : ((this._tMode = t), (this._tSend = e)),
                "REST" == this._tMode && ((this._tSend = !1), (this._endnm = !0));
            var a = "Content-Type";
            "JSON" == this._tMode && ((this._tSend = !1), (this._endnm = !0), (this._headers = this._headers || {}), (this._headers[a] = "application/json")),
                this._headers && !i(this._headers, a) && (this._headers[a] = "application/x-www-form-urlencoded");
        },
        escape: function (t) {
        ...
        setUpdated: function (t, e, i) {
            if (!this._silent_mode) {
                ...
                n && "updated" == i && (i = n),
                    e
                        ? (this.set_invalid(t, !1), (this.updatedRows[a] = t), this.obj.setUserData(t, this.action_param, i), this._in_progress[t] && (this._in_progress[t] = "wait"))
                        : this.is_invalid(t) || (this.updatedRows.splice(a, 1), this.obj.setUserData(t, this.action_param, "")),
            ...
            if (t) {
                ...
                var i = this,
                    a = function (a) {
                        var n = [];
                        if (e) n.push(e);
                        else if (t) for (var r in t) n.push(r);
                ...
                else if ("POST" == this._tMode) n.query({ url: s, method: "POST", headers: this._headers, data: this.serialize(t, e), callback: a });
                else if ("JSON" == this._tMode) {
                    var o = t[this.action_param],
                        d = {};
                    for (var l in t) d[l] = t[l];
                    delete d[this.action_param], delete d.id, delete d.gr_id, n.query({ url: s, method: "POST", headers: this._headers, callback: a, data: JSON.stringify({ id: e, action: o, data: d }) });
                } else if ("REST" == this._tMode) {
                    var _ = this.getState(e),
                        h = r.replace(/(\&|\?)editing\=true/, ""),
                        d = "",
                        c = "post";
                    "inserted" == _ ? (d = this.serialize(t, e)) : "deleted" == _ ? ((c = "DELETE"), (h = h + ("/" == h.slice(-1) ? "" : "/") + e)) : ((c = "PUT"), (d = this.serialize(t, e)), (h = h + ("/" == h.slice(-1) ? "" : "/") + e)),
        ...
        afterUpdateCallback: function (t, e, i, a) {
            var n = t,
                r = "error" != i && "invalid" != i;
            if ((r || this.set_invalid(t, i), this._uActions && this._uActions[i] && !this._uActions[i](a))) return delete this._in_progress[n];
            ...
            "wait" != this._in_progress[n] ? (r && this.obj.setUserData(t, this.action_param, ""), delete this._in_progress[n]) : (delete this._in_progress[n], this.setUpdated(e, !0, this.obj.getUserData(t, this.action_param))),
                this.callEvent("onAfterUpdate", [s, i, e, a]);
        },
        ...
        setAutoUpdate: function (t, e) {
            (t = t || 2e3),
                ...
                (this._need_update = !1),
                (this._update_busy = !1),
                this.attachEvent("onAfterUpdate", function (t, e, i, a) {
    ...
    (Scheduler.plugin = function (t) {
        ...
        (Scheduler.getSchedulerInstance = function () {
            ...
            function i(t) {
                ...
                if (i) {
                    var a = i(t);
                    if ((t.css && a.classList.add(t.css), t.width)) {
                        var n = t.width;
                        n === 1 * n && (n += "px"), (a.style.width = n);
                    }
                    if (t.height) {
                        var n = t.height;
                        n === 1 * n && (n += "px"), (a.style.height = n);
                    }
                    if ((t.click && a.addEventListener("click", t.click), t.html && (a.innerHTML = t.html), t.align)) {
                        var n = "";
                        "right" == t.align ? (n = "flex-end") : "left" == t.align && (n = "flex-start"), (a.style.justifyContent = n);
                    }
                    return a;
                }
            }
            ...
            function n(t) {
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    var l = i(o);
                    r.appendChild(l), (o.cols || o.rows) && l.appendChild(n(o.cols || o.rows));
                }
                return r;
            }
            function r(t) {
            ...
            function s(t) {
                var e = ["day", "week", "month"],
                    i = ["date"],
                    a = ["prev", "today", "next"];
                if (t.matrix) for (var n in t.matrix) e.push(n);
                if (t._props) for (var n in t._props) e.push(n);
                if (t._grid && t._grid.names) for (var n in t._grid.names) e.push(n);
                return (
            ...
            (g._update_nav_bar = function (t, e) {
                ...
                (g._init_once = function () {
                    ...
                    function e(t) {
                        return { w: t.innerWidth || document.documentElement.clientWidth, h: t.innerHeight || document.documentElement.clientHeight };
                    }
                    function i(t, e) {
                    ...
                    function a(a, n) {
                        var r,
                            s = e(n);
                        a.event(n, "resize", function () {
                            clearTimeout(r),
                                (r = setTimeout(function () {
                                    if (t(a.$container)) {
                                        var r = e(n);
                                        i(s, r) || ((s = r), a.callEvent("onSchedulerResize", []) && (a.updateView(), a.callEvent("onAfterSchedulerResize", [])));
                                    }
                                }, 150));
                        });
                    }
                    function n(t) {
                        ...
                        (i.className = "scheduler_container_resize_watcher"),
                            (i.tabIndex = -1),
                            t.config.wai_aria_attributes && (i.setAttribute("role", "none"), i.setAttribute("aria-hidden", !0)),
                            e.appendChild(i),
                            i.contentWindow ? a(t, i.contentWindow) : (e.removeChild(i), a(t, window));
                    }
                    n(g), (g._init_once = function () {});
                });
            var y = {
                navbar: {
                    render: function (t) {
            ...
            (g.init = function (t, e, i) {
                ...
                (g.set_sizes = function () {
                    var t = (this._x = this._obj.clientWidth - this.xy.margin_left),
                        ...
                        n = this.$container.querySelector(".dhx_cal_scale_placeholder");
                    g._is_material_skin()
                        ? (n || ((n = document.createElement("div")), (n.className = "dhx_cal_scale_placeholder"), this.$container.insertBefore(n, this._els.dhx_cal_header[0])),
                          (n.style.display = "block"),
                          this.set_xy(n, t, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1)))
                        ...
                        this.set_xy(this._els.dhx_cal_header[0], t - i, this.xy.scale_height, a, this.xy.nav_height + (this._quirks ? -1 : 1));
                ...
                (g.set_xy = function (t, e, i, a, n) {
                    var r = "left";
                    (t.style.width = Math.max(0, e) + "px"), (t.style.height = Math.max(0, i) + "px"), arguments.length > 3 && (this.config.rtl && (r = "right"), (t.style[r] = a + "px"), (t.style.top = n + "px"));
                }),
                (g.get_elements = function () {
                    for (var t = this._obj.getElementsByTagName("DIV"), e = 0; e < t.length; e++) {
                        ...
                        var n = g.locale.labels[a || i];
                        "string" != typeof n && a && !t[e].innerHTML && (n = a.split("_")[0]), n && (this._waiAria.labelAttr(t[e], n), (t[e].innerHTML = n));
                    }
                }),
                ...
                (g._click = {
                    dhx_cal_data: function (t) {
                        ...
                        if (i && g.config.select) {
                            g.select(i);
                            var a = g._getClassName(e);
                            -1 != a.indexOf("_icon") && g._click.buttons[a.split(" ")[1].replace("icon_", "")](i);
                ...
                (g.addEventNow = function (t, e, i) {
                    var a = {};
                    g._isObject(t) && !g._isDate(t) && ((a = t), (t = null));
                    var n = 6e4 * (this.config.event_duration || this.config.time_step);
                    t || (t = a.start_date || Math.round(g._currentDate().valueOf() / n) * n);
                    var r = new Date(t);
                    if (!e) {
                        var s = this.config.first_hour;
                        s > r.getHours() && (r.setHours(s), (t = r.valueOf())), (e = t.valueOf() + n);
                    }
                    var o = new Date(e);
                    r.valueOf() == o.valueOf() && o.setTime(o.valueOf() + n),
                        (a.start_date = a.start_date || r),
                        (a.end_date = a.end_date || o),
                        (a.text = a.text || this.locale.labels.new_event),
                        (a.id = this._drag_id = a.id || this.uid()),
                        (this._drag_mode = "new-size"),
                        (this._loading = !0);
                    var d = this.addEvent(a);
                    ...
                    if (((e = e || t.target || t.srcElement), !this.config.readonly)) {
                        ...
                        switch (i) {
                            ...
                            case "dhx_cal_event_clear":
                                var a = this._locate_event(e);
                                if (!this.callEvent("onDblClick", [a, t])) return;
                ...
                (g._get_column_index = function (t) {
                    ...
                    if (this._cols) {
                        ...
                        if (((e = a + (this._cols[a] ? (t - i) / this._cols[a] : 0)), this._ignores && e >= this._cols.length)) for (; e >= 1 && this._ignores[Math.floor(e)]; ) e--;
                    }
                    return e;
                }),
                ...
                (g._mouse_coords = function (t) {
                    ...
                    (e = this.$env.isIE || (!t.pageX && !t.pageY) ? { x: t.clientX + (i.scrollLeft || a.scrollLeft || 0) - i.clientLeft, y: t.clientY + (i.scrollTop || a.scrollTop || 0) - i.clientTop } : { x: t.pageX, y: t.pageY }),
                        this.config.rtl && this._colsS
                            ? ((e.x = this.$container.querySelector(".dhx_cal_data").offsetWidth - e.x), "month" !== this._mode && (e.x -= this.xy.scale_width))
                            : (e.x -= this.$domHelpers.getAbsoluteLeft(this._obj) + (this._table_view ? 0 : this.xy.scale_width));
                    var n = this.$container.querySelector(".dhx_cal_data");
                    (e.y -= this.$domHelpers.getAbsoluteTop(n) - this._els.dhx_cal_data[0].scrollTop), (e.ev = t);
                    ...
                    if (r) e = r.call(this, e);
                        ...
                        (e.y = Math.ceil((24 * (Math.max(0, s) + 7 * Math.max(0, o - 1)) * 60) / this.config.time_step)),
                            (g._drag_mode || "month" == this._mode) && (e.y = (24 * (Math.max(0, Math.ceil(s) - 1) + 7 * Math.max(0, o - 1)) * 60) / this.config.time_step),
                            "move" == this._drag_mode &&
                                g._ignores_detected &&
                                g.config.preserve_length &&
                                ((e._ignores = !0), this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, { x_step: 1, x_unit: "day" }))),
                            (e.x = 0);
                ...
                (g._correct_drag_end_date = function (t, e) {
                    ...
                    var a = 1 * t + g._get_fictional_event_length(t, e, i);
                    return new Date(1 * a - (g._get_fictional_event_length(a, -1, i, -1) + 1));
                }),
                (g._on_mouse_move = function (t) {
                    if (this._drag_mode) {
                        ...
                        if (this._is_pos_changed(this._drag_pos, e)) {
                            ...
                            var n = null;
                            if ((this._drag_pos && !this._drag_pos.has_moved && ((n = this._drag_pos), (n.has_moved = !0)), (this._drag_pos = e), (this._drag_pos.has_moved = !0), "create" == this._drag_mode)) {
                                if ((n && (e = n), this._close_not_saved(), this.unselect(this._select_id), (this._loading = !0), (i = this._get_date_from_pos(e).valueOf()), !this._drag_start)) {
                                    return this.callEvent("onBeforeEventCreated", [t, this._drag_id]) ? ((this._loading = !1), void (this._drag_start = i)) : void (this._loading = !1);
                                }
                                (a = i), this._drag_start;
                            ...
                            if ((g.matrix && (o = g.matrix[g._mode]), (o = o || { x_step: 1, x_unit: "day" }), "move" == this._drag_mode))
                                (i = this._min_date.valueOf() + 6e4 * (e.y * this.config.time_step + 24 * e.x * 60)),
                                    ...
                                    e._ignores && this.config.preserve_length && this._table_view
                                        ? ((i = g._correct_drag_start_date(i)), (a = g._correct_drag_end_date(i, this._drag_event._event_length)))
                                        : (a = l.end_date.valueOf() - (l.start_date.valueOf() - i));
                            else {
                                if (((i = l.start_date.valueOf()), (a = l.end_date.valueOf()), this._table_view)) {
                                    ...
                                    if ("month" == this._mode)
                                        if (((_ = this._correct_shift(_, !1)), this._drag_from_start)) {
                                            var h = 864e5;
                                            _ <= g.date.date_part(new Date(a + h - 1)).valueOf() && (i = _ - h);
                                        } else a = _;
                                    else this.config.preserve_length ? (e.resize_from_start ? (i = g._correct_drag_start_date(_)) : (a = g._correct_drag_end_date(_, 0))) : e.resize_from_start ? (i = _) : (a = _);
                                } else {
                                    ...
                                    var x = e.y * d * 6e4,
                                        ...
                                        y = 6e4 * p.y;
                                    (a = Math.abs(x - y) > Math.abs(b - y) ? c + b : c + x),
                                        (a += 6e4 * (new Date(a).getTimezoneOffset() - u.getTimezoneOffset())),
                                        (this._els.dhx_cal_data[0].style.cursor = "s-resize"),
                                        ("week" != this._mode && "day" != this._mode) || (a = this._correct_shift(a));
                                }
                                if ("new-size" == this._drag_mode)
                                    if (a <= this._drag_start) {
                                        var w = e.shift || (this._table_view && !e.custom ? 864e5 : 0);
                                        (i = a - (e.shift ? 0 : w)), (a = this._drag_start + (w || 6e4 * d));
                                    } else i = this._drag_start;
                                else a <= i && (a = i + 6e4 * d);
                            }
                            var D = new Date(a - 1),
                                E = new Date(i);
                            if ("move" == this._drag_mode && g.config.limit_drag_out && (+E < +g._min_date || +a > +g._max_date)) {
                                if (+l.start_date < +g._min_date || +l.end_date > +g._max_date) (E = new Date(l.start_date)), (a = new Date(l.end_date));
                                else {
                                    var A = a - E;
                                    +E < +g._min_date
                                        ? ((E = new Date(g._min_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? ((E = new Date(g._correct_drag_start_date(E))),
                                                ...
                                                (a = new Date(1 * E + this._get_fictional_event_length(E, this._drag_event._event_length, o))))
                                              : (a = new Date(+E + A)))
                                        : ((a = new Date(g._max_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? (o._end_correction && (a = new Date(a.valueOf() - o._end_correction)),
                                                (a = new Date(1 * a - this._get_fictional_event_length(a, 0, o, !0))),
                                                (E = new Date(1 * a - this._get_fictional_event_length(a, this._drag_event._event_length, o, !0))),
                                                this._ignores_detected && ((E = g.date.add(E, o.x_step, o.x_unit)), (a = new Date(1 * a - this._get_fictional_event_length(a, 0, o, !0))), (a = g.date.add(a, o.x_step, o.x_unit))))
                                              : (E = new Date(+a - A)));
                                }
                                var D = new Date(a - 1);
                            }
                            if (
                                ...
                                this._dragEventBody &&
                                !g.config.all_timed &&
                                ((!g._get_section_view() && e.x != this._get_event_sday({ start_date: new Date(i), end_date: new Date(i) })) || new Date(i).getHours() < this.config.first_hour)
                            ) {
                                var A = a - E;
                                if ("move" == this._drag_mode) {
                                    var h = this._min_date.valueOf() + 24 * e.x * 60 * 6e4;
                                    (E = new Date(h)), E.setHours(this.config.first_hour), (a = new Date(E.valueOf() + A)), (D = new Date(a - 1));
                                }
                            }
                            if (!this._table_view && !g.config.all_timed && ((!g.getView() && e.x != this._get_event_sday({ start_date: new Date(a), end_date: new Date(a) })) || new Date(a).getHours() >= this.config.last_hour)) {
                                var A = a - E,
                                    h = this._min_date.valueOf() + 24 * e.x * 60 * 6e4;
                                (a = g.date.date_part(new Date(h))), a.setHours(this.config.last_hour), (D = new Date(a - 1)), "move" == this._drag_mode && (E = new Date(+a - A));
                            }
                            if (this._table_view || (D.getDate() == E.getDate() && D.getHours() < this.config.last_hour) || g._allow_dnd)
                                if (((l.start_date = E), (l.end_date = new Date(a)), this.config.update_render)) {
                ...
                (g._on_mouse_down = function (t, e) {
                    if (2 != t.button && !this.config.readonly && !this._drag_mode) {
                        ...
                        if (this._drag_mode) {
                            var a = this._locate_event(e);
                            if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [a, this._drag_mode, t])) {
                                if (((this._drag_id = a), (this._edit_id != this._drag_id || (this._edit_id && "create" == this._drag_mode)) && this._close_not_saved(), !this._drag_mode)) return;
                ...
                (g._on_mouse_up = function (t) {
                    if (!t || 2 != t.button || !this._mobile) {
                        if (this._drag_mode && this._drag_id) {
                            ...
                            if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || n.start_date.valueOf() != this._drag_event.start_date.valueOf() || n.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                                var r = "new-size" == this._drag_mode;
                                if (this.callEvent("onBeforeEventChanged", [n, t, r, this._drag_event]))
                                    if (((this._drag_id = this._drag_mode = null), r && this.config.edit_on_create)) {
                                        if ((this.unselect(), (this._new_event = new Date()), this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(e))))
                                ...
                                else r ? this.deleteEvent(n.id, !0) : ((this._drag_event._dhx_changed = !1), this._clear_temporary_properties(n, this._drag_event), g._lame_copy(n, this._drag_event), this.updateEvent(n.id));
                            }
                ...
                (g._render_x_header = function (t, e, i, a, n) {
                    n = n || 0;
                    var r = document.createElement("div");
                ...
                (g._get_columns_num = function (t, e) {
                    var i = 7;
                    if (!g._table_view) {
                        var a = g.date["get_" + g._mode + "_end"];
                ...
                (g._calc_scale_sizes = function (t, e, i) {
                    ...
                    for (var s = r - this._ignores_detected, o = 0; o < r; o++)
                        this._ignores[o] ? ((this._cols[o] = 0), s++) : (this._cols[o] = Math.floor(n / (s - o))),
                            (n -= this._cols[o]),
                            (this._colsS[o] = (this._cols[o - 1] || 0) + (this._colsS[o - 1] || (this._table_view ? 0 : (a ? this.xy.scroll_width : this.xy.scale_width) + 2)));
                ...
                (g._render_scales = function (t, e) {
                    var i = new Date(g._min_date),
                        a = new Date(g._max_date),
                        n = this.date.date_part(g._currentDate()),
                        r = parseInt(t.style.width, 10),
                        s = new Date(this._min_date),
                        o = this._get_columns_num(i, a);
                    this._calc_scale_sizes(r, i, a);
                    var d = 0;
                    t.innerHTML = "";
                    for (var l = 0; l < o; l++) {
                ...
                (g._reset_scale = function () {
                    if (this.templates[this._mode + "_date"]) {
                        ...
                        (e.className = "dhx_cal_data" + a), (this._scales = {}), (this._cols = []), (this._colsS = { height: 0 }), (this._dy_shift = 0), this.set_sizes();
                        var n,
                            r,
                            s = this._get_timeunit_start(),
                            o = g._get_view_end();
                        (n = r = this._table_view ? g.date.week_start(s) : s), (this._min_date = n);
                ...
                (g._reset_hours_scale = function (t, e, i) {
                    ...
                    for (var n = new Date(1980, 1, 1, this.config.first_hour, 0, 0), r = 1 * this.config.first_hour; r < this.config.last_hour; r++) {
                        ...
                        var d = g.templates.hour_scale(n);
                        (s.innerHTML = d), this._waiAria.hourScaleAttr(s, d), a.appendChild(s), (n = this.date.add(n, 1, "hour"));
                    }
                    t.appendChild(a), this.config.scroll_hour && (t.scrollTop = this.config.hour_size_px * (this.config.scroll_hour - this.config.first_hour));
                }),
                ...
                (g._process_ignores = function (t, e, i, a, n) {
                    this._reset_ignores();
                    var r = g["ignore_" + this._mode];
                    if (r) for (var s = new Date(t), o = 0; o < e; o++) r(s) && ((this._ignores_detected += 1), (this._ignores[o] = !0), n && e++), (s = g.date.add(s, a, i)), g.date[i + "_start"] && (s = g.date[i + "_start"](s));
                }),
                (g._render_month_scale = function (t, e, i, a) {
                    function n(t) {
                    ...
                    var r = g.date.add(e, 1, "month"),
                        s = new Date(i),
                        o = g._currentDate();
                    this.date.date_part(o), this.date.date_part(i), (a = a || Math.ceil(Math.round((r.valueOf() - i.valueOf()) / 864e5) / 7));
                    for (var d = [], l = 0; l <= 7; l++) {
                    ...
                    for (var f = [], l = 0; l < a; l++) {
                        ...
                        u.appendChild(v);
                        for (var m = Math.max(n(l) - g.xy.month_head_height, 0), p = 0; p < 7; p++) {
                            ...
                            var y = "dhx_month_body",
                                w = "dhx_month_head";
                            if ((0 === p && this.config.left_border && ((y += " dhx_month_body_border"), (w += " dhx_month_head_border")), this._ignores_detected && this._ignores[p]))
                ...
                (g._reset_month_scale = function (t, e, i, a) {
                    var n = g.date.add(e, 1, "month"),
                        r = g._currentDate();
                    this.date.date_part(r), this.date.date_part(i), (a = a || Math.ceil(Math.round((n.valueOf() - i.valueOf()) / 864e5) / 7));
                    var s = Math.floor(t.clientHeight / a) - this.xy.month_head_height;
                    return (this._colsS.height = s + this.xy.month_head_height), (this._colsS.heights = []), g._render_month_scale(t, e, i, a);
                }),
                ...
                (g.getLabel = function (t, e) {
                    for (var i = this.config.lightbox.sections, a = 0; a < i.length; a++) if (i[a].map_to == t) for (var n = i[a].options, r = 0; r < n.length; r++) if (n[r].key == e) return n[r].label;
                    return "";
                }),
                ...
                (g._lame_clone = function (t, e) {
                    ...
                    if (t && "object" == typeof t) {
                        for (n = Object.create(t), a = [Array, Date, Number, String, Boolean], i = 0; i < a.length; i++) t instanceof a[i] && (n = i ? new a[i](t) : new a[i]());
                        e.push(t, n);
                        for (i in t) Object.prototype.hasOwnProperty.apply(t, [i]) && (n[i] = g._lame_clone(t[i], e));
                    }
                    return n || t;
                }),
                ...
                (g._get_real_event_length = function (t, e, i) {
                    var a,
                        ...
                        o = 0;
                    i.render ? ((o = this._get_date_index(i, t)), (a = this._get_date_index(i, e))) : (a = Math.round(n / 60 / 60 / 1e3 / 24));
                    for (var d = !0; o < a; ) {
                        var l = g.date.add(e, -i.x_step, i.x_unit);
                        s && s(e) && (!d || (d && s(l))) ? (n -= e - l) : ((d = !1), (n -= r)), (e = l), a--;
                    }
                    return n;
                }),
                (g._get_fictional_event_length = function (t, e, i, a) {
                    var n = new Date(t),
                        r = a ? -1 : 1;
                    if (i._start_correction || i._end_correction) {
                        var s;
                        s = a ? 60 * n.getHours() + n.getMinutes() - 60 * (i.first_hour || 0) : 60 * (i.last_hour || 0) - (60 * n.getHours() + n.getMinutes());
                    ...
                    var l,
                        ...
                        c = 0;
                    for (i.render ? ((c = this._get_date_index(i, n)), (l = this._get_date_index(i, _))) : (l = Math.round(e / 60 / 60 / 1e3 / 24)); c * r <= l * r; ) {
                        var u = g.date.add(n, i.x_step * r, i.x_unit);
                        h && h(n) && ((e += (u - n) * r), (l += r)), (n = u), (c += r);
                    }
                    return e;
                }),
                ...
                (function () {
                    ...
                    g._getFocusableNodes = function (n) {
                        for (
                            var r = n.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")),
                            ...
                            var d = s[o];
                            ((e(d) || a(d) || i(d)) && t(d)) || (s.splice(o, 1), o--);
                        }
                        return s;
                    };
                })(),
                ...
                (function () {
                    ...
                    g._waiAria = {
                        getAttributeString: function (i) {
                            var a = [" "];
                            for (var n in i)
                                if ("function" != typeof i[n] && "object" != typeof i[n]) {
                                    var r = e(t(i[n]));
                                    a.push(n + "='" + r + "'");
                                }
                        ...
                        gridCellAttrString: function (t, e, i) {
                            return this.getAttributeString({ role: "gridcell", "aria-label": [void 0 === e.label ? e.id : e.label, ": ", i] });
                        },
                        ...
                        weekAgendaDayCell: function (t, e) {
                            var i = t.querySelector(".dhx_wa_scale_bar"),
                                a = t.querySelector(".dhx_wa_day_data"),
                                n = g.uid() + "";
                            this.setAttributes(i, { id: n }), this.setAttributes(a, { "aria-labelledby": n });
                        },
                        ...
                        lightboxButtonAttrString: function (t) {
                            return this.getAttributeString({ role: "button", "aria-label": g.locale.labels[t], tabindex: "0" });
                        },
                ...
                (g.utils = {
                    mixin: function (t, e, i) {
                        for (var a in e) (void 0 === t[a] || i) && (t[a] = e[a]);
                        return t;
                    },
                    copy: function t(e) {
                        var i, a;
                        if (e && "object" == typeof e)
                            switch (!0) {
                                case h(e):
                                    ...
                                    break;
                                case o(e):
                                    for (a = new Array(e.length), i = 0; i < e.length; i++) a[i] = t(e[i]);
                                    break;
                                case d(e):
                                    a = new String(e);
                                    break;
                                ...
                                default:
                                    a = {};
                                    for (i in e) Object.prototype.hasOwnProperty.apply(e, [i]) && (a[i] = t(e[i]));
                            }
                        return a || e;
                    },
                }),
            ...
            (g.$env = {
                ...
                (g.$ajax = {
                    ...
                    parse: function (t) {
                        ...
                        return (
                            ...
                            window.DOMParser && !g.$env.isIE
                                ...
                                : window.ActiveXObject !== window.undefined && ((e = new window.ActiveXObject("Microsoft.XMLDOM")), (e.async = "false"), e.loadXML(t)),
                            e
                        );
                    },
                    ...
                    xpath: function (t, e) {
                        ...
                        for (var i, a = [], n = (e.ownerDocument || e).evaluate(t, e, null, XPathResult.ANY_TYPE, null); ; ) {
                            if (!(i = n.iterateNext())) break;
                            a.push(i);
                        }
                        return a;
                    },
                    ...
                    postLong: function (t, e, i) {
                        2 != arguments.length || ("function" != typeof e && (window[e], 0)) || ((i = e), (e = "")), this._call("POST", t, e, !0, i, { url: t, postData: e });
                    },
                    _call: function (t, e, i, a, n, r, s) {
                            ...
                            (a &&
                                (d.onreadystatechange = function () {
                                    if (4 == d.readyState || (l && 3 == d.readyState)) {
                                        ...
                                        window.setTimeout(function () {
                                            "function" == typeof n && n.apply(window, [{ xmlDoc: d, filePath: e }]), r && (void 0 !== r.postData ? this.postLong(r.url, r.postData, n) : this.getLong(r.url, n)), (n = null), (d = null);
                                        }, 1);
                                    }
                                }),
                        ...
                        if ((d.setRequestHeader("X-Requested-With", "XMLHttpRequest"), d.send(i), !a)) return { xmlDoc: d, filePath: e };
                    },
            ...
            var E = function (t, e) {
                for (var i = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", a = t.match(/%[a-zA-Z]/g), n = 0; n < a.length; n++)
                    switch (a[n]) {
                        case "%j":
                        case "%d":
                            i += "set[2]=temp[" + n + "]||1;";
            ...
            (g.date = {
                ...
                add: function (t, e, i) {
                    ...
                    switch (i) {
                        case "day":
                            a = g.date._add_days(a, e);
                            break;
                        case "week":
                            a = g.date._add_days(a, 7 * e);
                            break;
                        case "month":
                ...
                str_to_date: function (t, e, i) {
                    var a = E(t, e),
                        n = /^[0-9]{4}(\-|\/)[0-9]{2}(\-|\/)[0-9]{2} ?(([0-9]{1,2}:[0-9]{1,2})(:[0-9]{1,2})?)?$/,
                ...
                (g.addEvent = function (t, e, i, a, n) {
                    if (!arguments.length) return this.addEventNow();
                    var r = t;
                    1 != arguments.length && ((r = n || {}), (r.start_date = t), (r.end_date = e), (r.text = i), (r.id = a)),
                        (r.id = r.id || g.uid()),
                        (r.text = r.text || ""),
                ...
                (g.deleteEvent = function (t, e) {
                    ...
                    (e || (this.callEvent("onBeforeEventDelete", [t, i]) && this.callEvent("onConfirmedBeforeEventDelete", [t, i]))) &&
                        (i && ((this._select_id = null), delete this._events[t], this.event_updated(i), this._drag_id == i.id && ((this._drag_id = null), (this._drag_mode = null), (this._drag_pos = null))),
                    ...
                    for (
                        var t = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"],
                            ...
                            i = function (t) {
                                return function (e, i) {
                                    var a = g.getEvent(e);
                                    (a[t] = i), (a._changed = !0), (a._timed = this.isOneDayEvent(a)), g.event_updated(a, !0);
                                };
                            },
                            a = 0;
                        a < t.length;
                        ...
                        (g["getEvent" + t[a + 1]] = e(t[a])), (g["setEvent" + t[a + 1]] = i(t[a]));
                })(),
                ...
                (g._render_month_link = function (t) {
                    for (var e = this._rendered_location, i = this._lame_clone(t), a = t._sday; a < t._eday; a++) {
                        (i._sday = a), (i._eday = a + 1);
                        var n = g.date,
                            r = g._min_date;
                        (r = n.add(r, i._sweek, "week")), (r = n.add(r, i._sday, "day"));
                        var s = g.getEvents(r, n.add(r, 1, "day")).length,
                ...
                (g.render_data = function (t, e) {
                    ...
                    for (var i = {}, a = 0; a < t.length; a++)
                        if (this._table_view)
                            if ("month" != g._mode) this.render_event_bar(t[a]);
                            else {
                                var n = g.config.max_month_events;
                                n !== 1 * n || t[a]._sorder < n ? this.render_event_bar(t[a]) : void 0 !== n && t[a]._sorder == n && g._render_month_link(t[a]);
                            }
                        else {
                            var r = t[a],
                ...
                (g._pre_render_events = function (t, e) {
                    var i = this.xy.bar_height,
                        ...
                        n = (this._colsS.heights = [0, 0, 0, 0, 0, 0, 0]),
                        ...
                        if (e) this._colsS.heights = a;
                            ...
                            if (s.rows) {
                                for (var o = 0; o < s.rows.length; o++) {
                                    ...
                                    if (n[o] * i > l) {
                                        var _ = l;
                                        1 * this.config.max_month_events !== this.config.max_month_events || n[o] <= this.config.max_month_events
                                            ? (_ = n[o] * i)
                                            : (this.config.max_month_events + 1) * i > l && (_ = (this.config.max_month_events + 1) * i);
                                        for (var h = 0; h < d.length; h++) d[h].childNodes[1].style.height = _ + "px";
                                    }
                                    n[o] = (n[o - 1] || 0) + g._get_first_visible_cell(d).offsetHeight;
                                }
                                if ((n.unshift(0), s.parentNode.offsetHeight < s.parentNode.scrollHeight && !g._colsS.scroll_fix && g.xy.scroll_width)) {
                                    var c = g._colsS,
                                        u = c[c.col_length],
                                        f = c.heights.slice();
                                ...
                                var v = (s.parentNode.childNodes, (n[0] + 1) * i + 1),
                                    m = v,
                                    p = v + "px";
                                this.config.multi_day_height_limit && ((m = Math.min(v, this.config.multi_day_height_limit)), (p = m + "px")),
                                ...
                                (x.style.height = p), (x.style.visibility = -1 == n[0] ? "hidden" : "visible");
                                var b = this._els.dhx_multi_day[1];
                                (b.style.height = p),
                                    (b.style.visibility = -1 == n[0] ? "hidden" : "visible"),
                                    (b.className = n[0] ? "dhx_multi_day_icon" : "dhx_multi_day_icon_small"),
                                    (this._dy_shift = (n[0] + 1) * i),
                                    this.config.multi_day_height_limit && (this._dy_shift = Math.min(this.config.multi_day_height_limit, this._dy_shift)),
                                    (n[0] = 0),
                                    m != v && ((r.style.top = parseInt(r.style.top) + 2 + "px"), (x.style.overflowY = "auto"), (b.style.position = "fixed"), (b.style.top = ""), (b.style.left = ""));
                            }
                        }
                    return t;
                }),
                ...
                (g._pre_render_events_table = function (t, e) {
                    this._time_order(t);
                    for (var i, a = [], n = [[], [], [], [], [], [], []], r = this._colsS.heights, s = this._cols.length, o = {}, d = 0; d < t.length; d++) {
                        var l = t[d],
                            _ = l.id;
                        ...
                        if (((l._sday = f % s), !this._ignores[l._sday] || !l._timed)) {
                            ...
                            if (g._is_any_multiday_cell_visible(c, u, l)) {
                                ...
                                if (((l._sorder && e) || (l._sorder = m), l._sday + l._length <= s)) (i = null), a.push(l), (p[m] = l), (r[l._sweek] = p.length - 1), (l._first_chunk = h.first_chunk), (l._last_chunk = h.last_chunk);
                                else {
                ...
                (g.updateEvent = function (t) {
                    ...
                    this.clear_event(t),
                        e &&
                            ...
                            (this.config.update_render ? this.render_view_data() : "month" != this.getState().mode || this.getState().drag_id || this.isOneDayEvent(e) ? this.render_view_data([e], !0) : this.render_view_data());
                }),
                ...
                (g._calc_event_y = function (t, e) {
                    ...
                    var i = 60 * t.start_date.getHours() + t.start_date.getMinutes(),
                        a = 60 * t.end_date.getHours() + t.end_date.getMinutes() || 60 * g.config.last_hour;
                    return {
                        top: this._y_from_date(t.start_date),
                        height: Math.max(e, ((a - i) * this.config.hour_size_px) / 60),
                    };
                }),
                (g.render_event = function (t, e, i) {
                    var a = g.xy.menu_width,
                        n = this.config.use_select_menu_space ? 0 : a;
                    if (!(t._sday < 0)) {
                        ...
                        if (r) {
                            ...
                            if ((t._inner || (h *= l - _), this.config.cascade_event_display)) {
                                ...
                                h = Math.floor(i - n - c - v);
                            }
                            var m = this._render_v_bar(t, n + c, o, h, d, t._text_style, g.templates.event_header(t.start_date, t.end_date, t), g.templates.event_text(t.start_date, t.end_date, t));
                            this._waiAria.eventAttr(t, m), this._rendered.push(m), e.appendChild(m);
                            if (((c = c + parseInt(this.config.rtl ? r.style.right : r.style.left, 10) + n), this._edit_id == t.id)) {
                                (m.style.zIndex = 1),
                            ...
                            if (0 !== this.xy.menu_width && this._select_id == t.id) {
                                ...
                                var S = this._render_v_bar(t, c - a + 1, o, a, 20 * y.length + 26 - 2, "", "<div style='" + D + E + "' class='dhx_menu_head'></div>", w, !0);
                                (S.style.left = c - a + 1), this._els.dhx_cal_data[0].appendChild(S), this._rendered.push(S);
                            }
                            this.config.drag_highlight && this._drag_id == t.id && this.highlightEventPosition(t);
                        }
                    }
                }),
                (g._render_v_bar = function (t, e, i, a, n, r, s, o, d) {
                    ...
                    var f = t.color ? "background-color:" + t.color + ";" : "",
                        ...
                        x = m ? p : a - 4,
                        b = m ? p : a - 6,
                        y = m ? p : a - (this._quirks ? 4 : 14),
                        w = m ? p - 2 : a - 8,
                        D = m ? n - this.xy.event_header_height - 1 : n - (this._quirks ? 20 : 30) + 1,
                        E = '<div event_id="' + _ + '" class="' + h + '" style="position:absolute; top:' + i + "px; " + (this.config.rtl ? "right:" : "left:") + e + "px; width:" + x + "px; height:" + n + "px;" + (r || "") + '"></div>';
                    l.innerHTML = E;
                    var A = l.cloneNode(!0).firstChild;
                    if (!d && g.renderEvent(A, t, a, n, s, o)) return A;
                    A = l.firstChild;
                ...
                (g._get_event_bar_pos = function (t) {
                    var e = this.config.rtl,
                        ...
                        a = i[t._sday],
                        n = i[t._eday];
                    e && ((a = i[i.col_length] - i[t._eday] + i[0]), (n = i[i.col_length] - i[t._sday] + i[0])), n == a && (n = i[t._eday + 1]);
                    ...
                    var d = s * r;
                    return { x: a, x2: n, y: i.heights[t._sweek] + (i.height ? this.xy.month_scale_height + 2 : 2) + d };
                }),
                (g.render_event_bar = function (t) {
                    ...
                    if (r) {
                        ...
                        var m = t.color ? "background:" + t.color + ";" : "",
                            ...
                            x = ["position:absolute", "top:" + a + "px", "left:" + n + "px", "width:" + (r - n - 3 - (u ? 1 : 0)) + "px", p, m, t._text_style || ""].join(";"),
                ...
                (g._locate_css = function (t, e, i) {
                    void 0 === i && (i = !0);
                    for (var a = t.target || t.srcElement, n = ""; a; ) {
                        if ((n = g._getClassName(a))) {
                            var r = n.indexOf(e);
                            if (r >= 0) {
                                if (!i) return a;
                                var s = 0 === r || !g._trim(n.charAt(r - 1)),
                                    o = r + e.length >= n.length || !g._trim(n.charAt(r + e.length));
                                if (s && o) return a;
                            }
                        }
                        a = a.parentNode;
                ...
                (g.getRenderedEvent = function (t) {
                    if (t) {
                        for (var e = g._rendered, i = 0; i < e.length; i++) {
                            var a = e[i];
                            if (a.getAttribute("event_id") == t) return a;
                        }
                        return null;
                    }
                }),
                (g.showEvent = function (t, e) {
                    ...
                    if (((e = e || g._mode), a && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [a, e])))) {
                        ...
                        var s = a.color,
                            o = a.textColor;
                        if (
                            (g.config.highlight_displayed_event && ((a.color = g.config.displayed_event_color), (a.textColor = g.config.displayed_event_text_color)),
                            g.setCurrentView(new Date(a.start_date), e),
                            (a.color = s),
                            (a.textColor = o),
                ...
                (g._append_drag_marker = function (t) {
                    if (!t.parentNode) {
                        var e = g._els.dhx_cal_data[0],
                            i = e.lastChild,
                            a = g._getClassName(i);
                        a.indexOf("dhx_scale_holder") < 0 && i.previousSibling && (i = i.previousSibling), (a = g._getClassName(i)), i && 0 === a.indexOf("dhx_scale_holder") && i.appendChild(t);
                    }
                }),
                ...
                (g._load = function (t, e) {
                    ...
                    if ((t = t || this._load_url)) {
                        ...
                        if (((e = e || this._date), this._load_mode)) {
                            ...
                            a = e;
                            for (var r = !0; a < this._max_date; ) (a = this.date.add(a, 1, this._load_mode)), this._loaded[n(e)] && r ? (e = this.date.add(e, 1, this._load_mode)) : (r = !1);
                            var s = a;
                            do {
                                (a = s), (s = this.date.add(a, -1, this._load_mode));
                            } while (s > e && this._loaded[n(s)]);
                            if (a <= e) return !1;
                            for (g.$ajax.get(t + "&from=" + n(e) + "&to=" + n(a), i); e < a; ) (this._loaded[n(e)] = !0), (e = this.date.add(e, 1, this._load_mode));
                        } else g.$ajax.get(t, i);
                    ...
                    canParse: function (t, e) {
                        ...
                        try {
                            var i = g.$ajax.parse(e.responseText),
                                a = g.$ajax.xmltop("data", i);
                            if (a && "data" === a.tagName) return !0;
                        } catch (t) {}
                        return !1;
                    },
                    parse: function (t) {
                        ...
                        for (var a = g.$ajax.xpath("//coll_options", t.xmlDoc), n = 0; n < a.length; n++) {
                            var r = a[n].getAttribute("for"),
                                s = g.serverList[r];
                            s || (g.serverList[r] = s = []), s.splice(0, s.length);
                            for (var o = g.$ajax.xpath(".//item", a[n]), d = 0; d < o.length; d++) {
                                for (var l = o[d], _ = l.attributes, h = { key: o[d].getAttribute("value"), label: o[d].getAttribute("label") }, c = 0; c < _.length; c++) {
                                    var u = _[c];
                ...
                (g.json = g._parsers.json = {
                    ...
                    parse: function (t) {
                        ...
                        "string" == typeof t && (t = JSON.parse(t)),
                            ...
                            (e = e || []),
                            t.dhx_security && (window.dhtmlx && (dhtmlx.security_key = t.dhx_security), (g.security_key = t.dhx_security));
                        ...
                        for (var n in i)
                            if (i.hasOwnProperty(n)) {
                                ...
                                var r = i[n],
                                    s = g.serverList[n];
                                s || (g.serverList[n] = s = []), s.splice(0, s.length);
                ...
                (g.ical = g._parsers.ical = {
                    ...
                    parse_date: function (t, e, i) {
                        var a = t.split("T"),
                            n = !1;
                        a[1] && ((e = a[1].substr(0, 2)), (i = a[1].substr(2, 2)), (n = !("Z" != a[1][6])));
                        var r = a[0].substr(0, 4),
                            s = parseInt(a[0].substr(4, 2), 10) - 1,
                            o = a[0].substr(6, 2);
                        return g.config.server_utc || n ? new Date(Date.UTC(r, s, o, e, i)) : new Date(r, s, o, e, i);
                    },
                ...
                (g.formSection = function (t) {
                    ...
                    var n = document.getElementById(a.id),
                        ...
                        s = {
                            ...
                            node: r,
                            getValue: function (t) {
                                return g.form_blocks[a.type].get_value(r, t || {}, a);
                            },
                            setValue: function (t, e) {
                                return g.form_blocks[a.type].set_value(r, t, e || {}, a);
                            },
                        },
                        o = g._lightbox_controls["get_" + a.type + "_control"];
                    return o ? o(s) : s;
                }),
                ...
                (g._lightbox_controls.defaults = { template: { height: 30 }, textarea: { height: 200 }, select: { height: 23 }, time: { height: 20 } }),
                (g.form_blocks = {
                    template: {
                        render: function (t) {
                    ...
                    select: {
                        render: function (t) {
                            for (
                                var e = g._lightbox_controls.defaults.select, i = e ? e.height : 23, a = (t.height || i || "23") + "px", n = "<div class='dhx_cal_ltext' style='height:" + a + ";'><select style='width:100%;'>", r = 0;
                                r < t.options.length;
                                r++
                            )
                                n += "<option value='" + t.options[r].key + "'>" + t.options[r].label + "</option>";
                            return (n += "</select></div>");
                        },
                        set_value: function (t, e, i, a) {
                            var n = t.firstChild;
                    ...
                    time: {
                        render: function (t) {
                            ...
                            var e = t.time_format,
                                i = g.config,
                                a = g.date.date_part(g._currentDate()),
                                n = 1440,
                                r = 0;
                            g.config.limit_time_select && ((n = 60 * i.last_hour + 1), (r = 60 * i.first_hour), a.setHours(i.first_hour));
                            for (var s = "", o = 0; o < e.length; o++) {
                                ...
                                switch (d) {
                                    ...
                                    case "%H:%i":
                                        ...
                                        var v = r,
                                            m = a.getDate();
                                        for (t._time_values = []; v < n; ) {
                                            (_ += "<option value='" + v + "'>" + this.templates.time_picker(a) + "</option>"), t._time_values.push(v), a.setTime(a.valueOf() + 60 * this.config.time_step * 1e3);
                                            v = 24 * (a.getDate() != m ? 1 : 0) * 60 + 60 * a.getHours() + a.getMinutes();
                                        }
                                }
                                if (_) {
                        ...
                        set_value: function (t, e, i, a) {
                            function n(t, e, i) {
                                for (var n = a._time_values, r = 60 * i.getHours() + i.getMinutes(), s = r, o = !1, d = 0; d < n.length; d++) {
                                    var _ = n[d];
                                    if (_ === r) {
                                        o = !0;
                                        break;
                            ...
                            if (o.full_day) {
                                ...
                                (h.checked = 0 === g.date.time_part(i.start_date) && 0 === g.date.time_part(i.end_date)),
                                    ...
                                    (h.onclick = function () {
                                        if (h.checked) {
                                            var e = {};
                                            g.form_blocks.time.get_value(t, e, a),
                                        ...
                                        (d[l[0]].disabled = h.checked), (d[l[0] + d.length / 2].disabled = h.checked), n(d, 0, r || i.start_date), n(d, 4, s || i.end_date);
                                    });
                            }
                            if (o.auto_end_date && o.event_duration)
                                for (
                                    var c = function () {
                                            (r = new Date(d[l[3]].value, d[l[2]].value, d[l[1]].value, 0, d[l[0]].value)), (s = new Date(r.getTime() + 60 * g.config.event_duration * 1e3)), n(d, 4, s);
                                        },
                                        u = 0;
                                    u < 4;
                                    u++
                                    ...
                                    d[u].onchange = c;
                            n(d, 0, i.start_date), n(d, 4, i.end_date);
                        },
                        get_value: function (t, e, i) {
                            var a = t.getElementsByTagName("select"),
                                n = i._time_format_order;
                            if (
                                ((e.start_date = new Date(a[n[3]].value, a[n[2]].value, a[n[1]].value, 0, a[n[0]].value)),
                                (e.end_date = new Date(a[n[3] + 4].value, a[n[2] + 4].value, a[n[1] + 4].value, 0, a[n[0] + 4].value)),
                                !a[n[3]].value || !a[n[3] + 4].value)
                            ) {
                    ...
                    if (t) {
                        ...
                        (t.style.top = e ? Math.round(e + Math.max((a - t.offsetHeight) / 2, 0)) + "px" : Math.round(Math.max((a - t.offsetHeight) / 2, 0) + 9) + "px"),
                            document.documentElement.scrollWidth > document.body.offsetWidth
                                ? (t.style.left = Math.round(i + (document.body.offsetWidth - t.offsetWidth) / 2) + "px")
                ...
                (g.showCover = function (t) {
                    t && ((t.style.display = "block"), this._setLbPosition(t)),
                        g.config.responsive_lightbox && (document.documentElement.classList.add("dhx_cal_overflow_container"), document.body.classList.add("dhx_cal_overflow_container")),
                        this.show_cover();
                }),
                ...
                (g._fill_lightbox = function (t, e) {
                    ...
                    if (g.templates.lightbox_header) {
                        ...
                        n.push(r), (a[1].innerHTML = ""), (a[2].innerHTML = r);
                    } else {
                        ...
                        n.push(s), n.push(o), (a[1].innerHTML = s), (a[2].innerHTML = o);
                    }
                    this._waiAria.lightboxHeader(e, n.join(" "));
                ...
                (g._init_lightbox_events = function () {
                    (this.getLightbox().onclick = function (t) {
                            ...
                            if (e && i)
                                switch (i) {
                                    case "dhx_save_btn":
                                        ...
                                        break;
                                    case "dhx_delete_btn":
                                        var a = g.locale.labels.confirm_deleting;
                                        g._dhtmlx_confirm(a, g.locale.labels.title_confirm_deleting, function () {
                                    ...
                                    default:
                                        if (e.getAttribute("dhx_button")) g.callEvent("onLightboxButton", [i, e, t]);
                                            ...
                                            -1 != i.indexOf("dhx_custom_button") &&
                                                (-1 != i.indexOf("dhx_custom_button_") ? ((n = e.parentNode.getAttribute("index")), (s = e.parentNode.parentNode)) : ((n = e.getAttribute("index")), (s = e.parentNode), (e = e.firstChild))),
                                                n && ((r = g.form_blocks[g.config.lightbox.sections[n].type]), r.button_click(n, e, s, s.nextSibling));
                                        }
                                }
                        }
                    }),
                        (this.getLightbox().onkeydown = function (t) {
                            ...
                            switch ((a || (a = i.parentNode.querySelector(".dhx_custom_button, .dhx_readonly")), (t || e).keyCode)) {
                                case 32:
                                ...
                                case g.keys.edit_save:
                                    if ((t || e).shiftKey) return;
                                    a && a.click ? a.click() : g.save_lightbox();
                                    break;
                ...
                (g.getLightbox = function () {
                    if (!this._lightbox) {
                        ...
                        for (var e = this._lightbox_template, i = this.config.buttons_left, a = "", n = 0; n < i.length; n++)
                            (a = this._waiAria.lightboxButtonAttrString(i[n])),
                                (e +=
                                    "<div " + a + " class='dhx_btn_set dhx_" + (g.config.rtl ? "right" : "left") + "_btn_set " + i[n] + "_set'><div dhx_button='1' class='" + i[n] + "'></div><div>" + g.locale.labels[i[n]] + "</div></div>");
                        i = this.config.buttons_right;
                        for (var r = g.config.rtl, n = 0; n < i.length; n++)
                            (a = this._waiAria.lightboxButtonAttrString(i[n])),
                                (e +=
                                    "<div " +
                                    a +
                        ...
                        for (var n = 0; n < s.length; n++) {
                            var o = this.form_blocks[s[n].type];
                            if (o) {
                                s[n].id = "area_" + this.uid();
                                var d = "";
                                if (s[n].button) {
                                    var a = g._waiAria.lightboxSectionButtonAttrString(this.locale.labels["button_" + s[n].button]);
                                    d = "<div " + a + " class='dhx_custom_button' index='" + n + "'><div class='dhx_custom_button_" + s[n].button + "'></div><div>" + this.locale.labels["button_" + s[n].button] + "</div></div>";
                                }
                                this.config.wide_form && (e += "<div class='dhx_wrap_section'>");
                                var l = this.locale.labels["section_" + s[n].name];
                                "string" != typeof l && (l = s[n].name), (e += "<div id='" + s[n].id + "' class='dhx_cal_lsection'>" + d + "<label>" + l + "</label></div>" + o.render.call(this, s[n])), (e += "</div>");
                            }
                        }
                        for (var _ = t.getElementsByTagName("div"), n = 0; n < _.length; n++) {
                            var h = _[n];
                ...
                (g._bindLightboxLabels = function (t) {
                    for (var e = 0; e < t.length; e++) {
                        ...
                        if (i.id && document.getElementById(i.id)) {
                            for (var a = document.getElementById(i.id), n = a.querySelector("label"), r = g._get_lightbox_section_node(i); r && !r.querySelector; ) r = r.nextSibling;
                            var s = !0;
                            if (r) {
                                var o = r.querySelector("input, select, textarea");
                                o && ((i.inputId = o.id || "input_" + g.uid()), o.id || (o.id = i.inputId), n.setAttribute("for", i.inputId), (s = !1));
                            }
                            if (s) {
                            ...
                            ? this._touch_events(
                                  ...
                                  function (t) {
                                      return t.touches && t.touches.length > 1
                                          ? null
                                          : t.touches[0]
                                          ? { target: t.target, pageX: t.touches[0].pageX, pageY: t.touches[0].pageY, clientX: t.touches[0].clientX, clientY: t.touches[0].clientY }
                                          : t;
                                  },
                                  function () {
                                      return !1;
                ...
                (g._touch_events = function (t, e, i) {
                    ...
                    function n(t, e, i, a) {
                        if (!t || !e) return !1;
                        for (var n = t.target; n && n != g._obj; ) n = n.parentNode;
                        if (n != g._obj) return !1;
                        ...
                        return r < a && s > i && (!r || s / r > 3) && (t.pageX > e.pageX ? g._click.dhx_cal_next_button() : g._click.dhx_cal_prev_button(), !0);
                    }
                    function r(t) {
                        if (!i(t)) {
                            var e = g.getState().drag_mode,
                                a = !!g.matrix && g.matrix[g._mode],
                                n = g.render_view_data;
                            return (
                                "create" == e &&
                                    a &&
                                    (g.render_view_data = function () {
                                        for (var t = g.getState().drag_id, e = g.getEvent(t), i = a.y_property, n = g.getEvents(e.start_date, e.end_date), r = 0; r < n.length; r++) n[r][i] != e[i] && (n.splice(r, 1), r--);
                                        (e._sorder = n.length - 1), (e._count = n.length), this.render_data([e], g.getState().mode);
                                    }),
                                g._on_mouse_move(t),
                                "create" == e && a && (g.render_view_data = n),
                    ...
                    a(document.body, t[0], function (t) {
                        if (!i(t)) {
                            var a = e(t);
                            if (a) {
                                if (_) return r(a), t.preventDefault && t.preventDefault(), (t.cancelBubble = !0), g._update_global_tip(), !1;
                        ...
                        a(this._els.dhx_cal_data[0], "touchcancel", s),
                        a(this._els.dhx_cal_data[0], "contextmenu", function (t) {
                            if (!i(t)) return c ? (t && t.preventDefault && t.preventDefault(), ((t || event).cancelBubble = !0), !1) : void 0;
                        }),
                        a(this._obj, t[1], function (t) {
                            if ((document && document.body && document.body.classList.add("dhx_cal_touch_active"), !i(t))) {
                                g._pointerDragId = t.pointerId;
                                var a;
                                if (((_ = h = !1), (c = !0), !(a = d = e(t)))) return void (h = !0);
                                var n = new Date();
                                if (!h && !_ && n - u < 250)
                                    return (
                                        g._click.dhx_cal_data(a),
                                        window.setTimeout(function () {
                                            (a.type = "dblclick"), g._on_dbl_click(a);
                                        }, 50),
                                        t.preventDefault && t.preventDefault(),
                                        (t.cancelBubble = !0),
                                ...
                                if (((u = n), !h && !_ && g.config.touch_drag)) {
                                    var r = g._locate_event(document.activeElement),
                                        s = g._locate_event(a.target),
                                        f = o ? g._locate_event(o.target) : null;
                                    if (r && s && r == s && r != f) return t.preventDefault && t.preventDefault(), (t.cancelBubble = !0), (g._ignore_next_click = !1), g._click.dhx_cal_data(a), (o = a), !1;
                        ...
                        a(this._els.dhx_cal_data[0], t[2], function (t) {
                            if ((document && document.body && document.body.classList.remove("dhx_cal_touch_active"), !i(t)))
                                return (
                                    g.config.touch_swipe_dates && !_ && n(o, d, 200, 100) && (g._block_next_stop = !0),
                                    _ &&
                                    ...
                                    s(t),
                                    g._block_next_stop ? ((g._block_next_stop = !1), t.preventDefault && t.preventDefault(), (t.cancelBubble = !0), !1) : void 0
                                );
                        }),
                ...
                (g._update_global_tip = function (t) {
                    ...
                    if (e) {
                        var i = "";
                        if (g._drag_id && !t) {
                            var a = g.getEvent(g._drag_id);
                            a && (i = "<div>" + (a._timed ? g.templates.event_header(a.start_date, a.end_date, a) : g.templates.day_date(a.start_date, a.end_date, a)) + "</div>");
                        }
                ...
                (g._dp_init = function (t) {
                    ...
                    var e = function (t, i, a) {
                            (a = a || ""), (i = i || {});
                            for (var n in t) 0 !== n.indexOf("_") && (t[n] && t[n].getUTCFullYear ? (i[a + n] = this.obj._helpers.formatDate(t[n])) : t[n] && "object" == typeof t[n] ? e.call(this, t[n], i, a + n + ".") : (i[a + n] = t[n]));
                            return i;
                        },
                        i = function (t) {
                            var e = g.utils.copy(t);
                            for (var a in e) 0 === a.indexOf("_") ? delete e[a] : e[a] && (e[a].getUTCFullYear ? (e[a] = this.obj._helpers.formatDate(e[a])) : "object" == typeof e[a] && (e[a] = i(e[a])));
                            return e;
                        };
                    (t._getRowData = function (t, a) {
                        var n = this.obj.getEvent(t);
                        return "JSON" == this._tMode ? i.call(this, n) : e.call(this, n);
                    }),
                ...
                (g._skin_settings = { fix_tab_position: [1, 0], use_select_menu_space: [1, 0], wide_form: [1, 0], hour_size_px: [44, 42], displayed_event_color: ["#ff4a4a", "ffc5ab"], displayed_event_text_color: ["#ffef80", "7e2727"] }),
            ...
            window.addEventListener("DOMContentLoaded", f),
                ...
                (g._skin_init = function () {
                    ...
                    var a = 0;
                    if ((!g.skin || ("classic" !== g.skin && "glossy" !== g.skin) || (a = 1), g._is_material_skin())) {
                        var n = g.config.buttons_left.$inital,
                            r = g.config.buttons_right.$inital;
                        if (n && g.config.buttons_left.slice().join() == n && r && g.config.buttons_right.slice().join() == r) {
                    ...
                    if (
                        (this._configure(g.config, g._skin_settings, a),
                        this._configure(g.xy, g._skin_xy, a),
                        "flat" === g.skin &&
                            ...
                            g.attachEvent("onTemplatesReady", function () {
                                ...
                                if (
                                    ((g.templates.month_day = function (i) {
                                        if ("month" == this._mode) {
                                            var a = t(i);
                                            return 1 == i.getDate() && (a = g.locale.date.month_full[i.getMonth()] + " " + a), +i == +g.date.date_part(this._currentDate()) && (a = g.locale.labels.dhx_cal_today_button + " " + a), a;
                                        }
                                    ...
                                    var i = g._els.dhx_cal_navline[0].getElementsByTagName("div"),
                                        ...
                                        r = [14, 75, 136],
                                        s = 14;
                                    g._is_material_skin() && ((r = [16, 103, 192]), (n = 294), (s = -1));
                                        ...
                                        if (l) {
                                            switch (((d.style.right = "auto"), l)) {
                                                ...
                                                case "month_tab":
                                                    ...
                                                    break;
                                                default:
                                                    (d.style.left = n + "px"), (d.className += " dhx_cal_tab_standalone"), (n = n + s + d.offsetWidth);
                                            }
                                            d.className += " " + l;
                                        } else 0 === (d.className || "").indexOf("dhx_minical_icon") && d.parentNode == g._els.dhx_cal_navline[0] && (a = d);
                                    }
                                    a && (a.style.left = n + "px");
                                }
                            }),
                ...
                (function () {
                    ...
                    var e = g.setCurrentView,
                        ...
                        r = function (e, r) {
                            var s = this;
                            window.clearTimeout(n), window.clearTimeout(a);
                            var o = s._date,
                                d = s._mode;
                            t(this, e, r),
                                (n = setTimeout(function () {
                                    if (!s.callEvent("onBeforeViewChange", [d, o, r || s._mode, e || s._date])) return void t(s, o, d);
                                    i.call(s, e, r), s.callEvent("onViewChange", [s._mode, s._date]), window.clearTimeout(a), (n = 0);
    ...
    !(function () {
        -1 == document[_0xaedc[1]][_0xaedc[0]][_0xaedc[3]](_0xaedc[2]) &&
            setTimeout(function () {
                dhtmlx[_0xaedc[6]]({ type: _0xaedc[4], text: _0xaedc[5], expire: -1 });
            }, Math[_0xaedc[8]](5e3 * Math[_0xaedc[7]]()) + 1e3);
    })(),
        dhtmlx &&
            dhtmlx.attaches &&
            (dhtmlx.attaches.attachScheduler = function (t, e, i, a) {
