    ...
    Scheduler.plugin = function(t) {
        ...
        function a(t) {
            ...
            for (var s = 0; s < e.length; s++) {
                var o = n(e[s]),
                    d = i(o);
                r.appendChild(d), (o.cols || o.rows) && d.appendChild(a(o.cols || o.rows))
            }
            return r
        }
        ...
        l.init = function(t, e, i) {
            ...
            l._on_dbl_click = function(t, e) {
                ...
                if (a) e = a.call(this, e);
                    ...
                    e.y = Math.ceil(24 * (Math.max(0, r) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step), (l._drag_mode || "month" == this._mode) && (e.y = 24 * (Math.max(0, Math.ceil(r) - 1) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step), "move" == this._drag_mode && l._ignores_detected && l.config.preserve_length && (e._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, {
                        x_step: 1,
                        x_unit: "day"
                    }))), e.x = 0
                ...
                if (2 != t.button && !this.config.readonly && !this._drag_mode) {
                    ...
                    if (this._drag_mode) {
                        ...
                        if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [n, this._drag_mode, t])) {
                            ...
                            this._drag_event = l._lame_clone(this.getEvent(this._drag_id) || {}), this._drag_pos = this._mouse_coords(t)
        ...
        l.date = {
                ...
                var r = t;
                1 != arguments.length && (r = a || {}, r.start_date = t, r.end_date = e, r.text = i, r.id = n), r.id = r.id || l.uid(), r.text = r.text || "", "string" == typeof r.start_date && (r.start_date = this.templates.api_date(r.start_date)), "string" == typeof r.end_date && (r.end_date = this.templates.api_date(r.end_date));
            ...
            l._xmlNodeToJSON = function(t) {
                ...
                var a = document.getElementById(n.id),
                    ...
                    s = {
                        ...
                        node: r,
                        getValue: function(t) {
                            return l.form_blocks[n.type].get_value(r, t || {}, n)
                        },
                        setValue: function(t, e) {
                            return l.form_blocks[n.type].set_value(r, t, e || {}, n)
                        }
                    },
                ...
                templateh: {
                    render: function(t) {
                        var e = l._lightbox_controls.defaults.template,
                            i = e ? e.height : 30;
                        return "<div class='dhx_cal_ltext dhx_cal_templateh' style='height:" + (t.height || i || 30) + "px;'></div>"
                    },
                    set_value: function(t, e, i, n) {
                        t.innerHTML = e || ""
                    },
